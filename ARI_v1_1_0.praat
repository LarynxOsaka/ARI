########################################################################
form ARI based on SFEEDS ver.1_1_0 (cs＋sv)
...
clearinfo
indexline$ = "FileName" + tab$ + "ARI" + tab$ + "ABI" + tab$ + "chaoticNoise_Power_of_all" 
...
indexline$ = indexline$ + "cpps" + tab$ + "jitterLocal" + tab$ + "shimmerLocal" + tab$ + "shimmerLocaldB" + tab$ + "psd" + tab$
...
if sampleRate <> 44100
    ...
    #Remove
    selectObject: "Sound " + name1$ + "_44100"
    Rename: name1$
endif
...
if sampleRate <> 44100
    Resample: 44100, 50
    #selectObject: "Sound " + name2$
    #Remove
    selectObject: "Sound " + name2$ + "_44100"
    Rename: name2$
endif
#Extract 1 ch if the audio sample has more than 1 channel.
ch = Get number of channels
...
#■Extract the central 3 seconds of the SV sample
...
resultline$ = resultline$ + tab$ + string$(finalhfno6000) + tab$ + string$(finalhnrd) + tab$ + string$(finalH1H2) + tab$ + string$(cpps) 
